import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as a,f as s}from"./app-bef95bfb.js";const d={},n=s(`<h2 id="q-如何通过wifi连接到路由器" tabindex="-1"><a class="header-anchor" href="#q-如何通过wifi连接到路由器" aria-hidden="true">#</a> Q: 如何通过Wifi连接到路由器？</h2><p>A: 目前，HOUZZkit OS 暂不支持通过UI来管理wifi设备（研发中）。可以通过以下终端命令来实现wifi连接。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>sudo nmcli device wifi connect {ssid} password {password} ifname wlan0
